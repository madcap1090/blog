...
Obviously too small. But you can look at a larger image [here](https://badtothecode.netlify.com/img/20190728/graph_big.png). The colors of the incoming arows indicate which party they are from and 
...
Click [here](https://badtothecode.netlify.com/img/20190728/friends) for the interactie graph (hover for handle and name, and drag for fun)