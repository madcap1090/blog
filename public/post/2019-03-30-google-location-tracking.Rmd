...
So I downloaded the data, that comes in json format, and had a go at it. You can [download](https://takeout.google.com/settings/takeout) yours from your Google account. 
...
locations <- data$locations # and the list contians a dataframe
...
ggmap(belgium) + geom_point(data = x, aes(x = lon, y = lat), alpha = 0.1, color = "black", size = .5) + 
