...
Let's start by reconstructing the list. Then we can search Twitter for their Twitter accounts. So a bit of grunt work and no nice visuals in this post, but it is needed to harvest parlaimentarians' tweets soonish. 
...
These seem obviously wrong. What would the complete list look like?
