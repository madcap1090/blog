...
So these top ones have been quite prolific. 
...
The frame is a bit too big to be incorporated nicely in the markdown file. 

A full interactive page can be found [here](https://badtothecode.netlify.com/img/20191212/ldavis/index.html#topic=9&lambda=0.4&term=)


<iframe width='1200px' height='950px' src='https://badtothecode.netlify.com/img/20191212/ldavis/index.html#topic=9&lambda=0.4&term=' >
...
Topic eight for instance seems now to be the topic of the reviews of beers people liked:
...
There is still is a s*** laod of avenues to explore with topic modeling and I'm sure we will get back to them, but this post is already a bit too long so concluding with the mapping of the 20 most commented beers with the same analysis frame.
