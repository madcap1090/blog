...
![optional caption text](~/R/blog/content/post/files/20190413/stu.png)
...
I hoped for a bit cleaner data and the possibility to easyly compare the evolution of the time spent commuting over several years. But it'll take the 12.18 minutes for now. 
...
I was looking to see how many of them we are doing, but as you will see below the datapoints are mostly centered on the building itself.
