...
So the emotions are a bit more complicated here. They usualy are. This time we have some more emotions.confidence though. 
...
So the more disgusted are Vuye&Wouters and Vlaams Belang. The majority of them are happy. But the hapiest are (is) the Parti Populaire. 

But these are the smaller parties.
