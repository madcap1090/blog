...
TRUE is good. TRUE will set you free. We can convert them with the magick package. 
...
```{r, eval=FALSE}
# test
put_object("./data/20190511/jpg/Almaci Meyrem.jpg", bucket = "reps666", object = "Almaci Meyrem.jpg")
```

TRUE is good, it will set you free.
