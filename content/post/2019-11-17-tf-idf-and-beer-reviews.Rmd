...
We have our data now, we scraped it from the web like we showed [here](https://badtothecode.netlify.com/post/beer-reviews-galore/). How can we best start looking at the data?
...
You might want to search for dancing alligators for instance.
