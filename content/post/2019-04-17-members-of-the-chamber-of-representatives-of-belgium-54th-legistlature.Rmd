...
Analysing the Red Devil's website code, it appears the pictures are to be found in an aws bucket s3 folder. 

![Inspecting the code of the webpage](/img/20190417/Eden.png)

Downloadng the pictures of the men:
...
Next is downloadng the pictures of the women:
...
There are 978 pictures of national soccer players; 709 men and 269 women. Most of these pictures seem to be recent, but there is no date tag or something similar. On the other hand the site only publishes currently selected players, so this inticates the pictures overall, are fairly recent.  

Sampeling 176 of them:
...
ok so it is a bit messy above, but below the thing we have to do is image scale
