...
So if I read this correcttly this object is a list of one, containing a dataframe with another two objects, a timestamp and another list of one, that contains a dataframe with 5 observations and two variables, the type of activity and the probabilty calculated for it. So on timestamp "1395248054966" I had a 49% probablility to be on foot. 
...
So that is pretty consistant with my favorite downtown haunts. Let's pan out and add the number of seconds from 6 am in the day to the dataframe. 
