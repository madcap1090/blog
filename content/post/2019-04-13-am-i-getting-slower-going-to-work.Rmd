...
I'll have a go also at the [bbplot]https://bbc.github.io/rcookbook/#how_to_create_bbc_style_graphics) package. 
...
windowsFonts(Helvetica = "TT Arial") # issue with bbc thme fonts
# https://github.com/bbc/bbplot/issues/10
```
...
ggplot(df, aes(x = datetime, y = lat)) +
...
font_import() #importing extra fonts
y
...
2018 seems to have the cleanest data at this point. I sometimes walk to work or take the bus or the car. All of these take me more time than biking to work. There are five trafic lights on the way and I tend to stop for trafic lights when they are red. 

I bike ride would not take more than twenty minutes, and surely not less than 5.
...
Finally I wanted to share the patés with you. Not often enough part of the team takes a break and walks around the office block. 

Rumor has it our boss does not like that, and apparantly it is against HR regulations. But hey, life is short, it's good for our health and walking meetings are the new thing.
