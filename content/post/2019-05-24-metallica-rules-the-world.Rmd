...
At this point 'concert_url' contains the urls of the concert we did not have in the data since our latest scraping. We need to suffix it with "https://www.setlist.fm". 
