...
There are also some demographical data at hand. But they need to b extracted from a column. Here under with a bit of a slow loop but I have to run errands anyway.
...
```{r}
#saveRDS(new_df, "~/R/dev_blog_post/content/post/data/20191222/df_demog.rds")
getwd()
